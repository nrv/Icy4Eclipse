 ...
 * 
 */
public class EzPlugProjectTemplate implements IcyProjectTemplate, Icy4EclipseCommonResources {
	@Override
	public String getPluginMainClassImplementation(String pluginName, String packageName, String className) {
		...
		javaFile.append("\n");
		javaFile.append("import plugins.adufour.ezplug.EzPlug;\n");
		javaFile.append("import icy.gui.dialog.MessageDialog;\n");
		javaFile.append("\n");
		javaFile.append("public class "+className+" extends EzPlug {\n");
		javaFile.append("\n");
		javaFile.append("\t@Override\n");
		javaFile.append("\tprotected void initialize() {\n");
		javaFile.append("\t\t// TODO Auto-generated by Icy4Eclipse\n");
		javaFile.append("\t}\n");
		javaFile.append("\n");
		javaFile.append("\t@Override\n");
		javaFile.append("\tprotected void execute() {\n");
		javaFile.append("\t\t// TODO Auto-generated by Icy4Eclipse\n");
		javaFile.append("\t\tMessageDialog.showDialog(\""+pluginName+" is working fine !\");\n");
		javaFile.append("\t}\n");
		javaFile.append("\n");
		javaFile.append("\t@Override\n");
		javaFile.append("\tpublic void clean() {\n");
		javaFile.append("\t\t// TODO Auto-generated by Icy4Eclipse\n");
		javaFile.append("\t}\n");
		javaFile.append("}\n");
	...
	public String getTemplateDescription() {
		return "create a default plugin based on the EzPlug library";
	}

	@Override
	public List<IClasspathEntry> getSpecificClasspathEntries() {
		ArrayList<IClasspathEntry> lst = new ArrayList<IClasspathEntry>();
		lst.add(JavaCore.newVariableEntry(new Path(ICY4ECLIPSE_HOME_VARIABLE + "/" + ICY_PLUGINS_DIR + "/adufour/ezplug/ezplug.jar"), null, null));
		return lst;
	}
