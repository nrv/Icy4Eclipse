...
package icy.icy4eclipse.core.action;

import icy.icy4eclipse.core.Icy4EclipsePlugin;
 ...
 *
 */
public class StartIcyDebugAction implements IWorkbenchWindowActionDelegate {
	@Override
	public void run(IAction ac) {
		Icy4EclipsePlugin.startIcyDebug();
	}
